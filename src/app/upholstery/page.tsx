      ...
      <section className="py-24 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 mt-4 text-lg max-w-xl mx-auto">Set of dining chairs â€” stained fabric restored to like-new condition with RFâ„¢ upholstery cleaning.</p>
          </div>

          {/* BEFORE ROW */}
          <div className="mb-6">
            <div className="inline-flex items-center gap-2 bg-red-50 border border-red-200 text-red-700 text-xs font-bold px-4 py-2 rounded-full mb-6">BEFORE â€” Stained dining chair fabric</div>
            <div className="grid md:grid-cols-3 gap-4">
              {["upholstery-before-1.jpg","upholstery-before-2.jpg","upholstery-before-3.jpg"].map((img,i) => (
                <div key={i} className="relative rounded-2xl overflow-hidden shadow-lg group">
                  <img src={`/images/${img}`} alt={`Dining chair upholstery before RF cleaning â€” chair ${i+1}`} className="w-full h-56 object-cover group-hover:scale-105 transition-transform duration-500" />
                  <div className="absolute top-4 left-4 bg-red-500 text-white text-xs font-black px-3 py-1 rounded-full">BEFORE</div>
                </div>
              ))}
            </div>
          ...
          {/* DURING */}
          <div className="mb-6">
            <div className="inline-flex items-center gap-2 bg-orange-50 border border-orange-200 text-orange-700 text-xs font-bold px-4 py-2 rounded-full mb-6">DURING â€” RFâ„¢ extraction in progress</div>
            <div className="grid md:grid-cols-1 gap-4 max-w-sm">
              <div className="relative rounded-2xl overflow-hidden shadow-lg group">
                <img src="https://d1chim18wmcawu.cloudfront.net/images/upholstery-during.jpg" alt="Upholstery cleaning in progress â€” RF extraction wand on chair" className="w-full h-56 object-cover group-hover:scale-105 transition-transform duration-500" />
                <div className="absolute top-4 left-4 bg-orange-500 text-white text-xs font-black px-3 py-1 rounded-full">DURING</div>
              </div>
            </div>
          </div>
          ...
          {/* AFTER ROW */}
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 bg-teal-50 border border-teal-200 text-teal-700 text-xs font-bold px-4 py-2 rounded-full mb-6">AFTER â€” Clean restored fabric</div>
            <div className="grid md:grid-cols-3 gap-4">
              {["upholstery-after-1.jpg","upholstery-after-2.jpg","upholstery-after-3.jpg"].map((img,i) => (
                <div key={i} className="relative rounded-2xl overflow-hidden shadow-lg group">
                  <img src={`/images/${img}`} alt={`Dining chair upholstery after RF cleaning â€” chair ${i+1}`} className="w-full h-56 object-cover group-hover:scale-105 transition-transform duration-500" />
                  <div className="absolute top-4 left-4 bg-teal-500 text-white text-xs font-black px-3 py-1 rounded-full">AFTER</div>
                </div>
              ))}
            </div>
